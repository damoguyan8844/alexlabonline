...
public:
    ...
    BOOL SortItems(PFNLVCOMPARE pfnCompare, int nCol, int nKeyCol, BOOL bAscending, LPARAM data = 0);
...
protected:
    ...
    BOOL SortItems(PFNLVCOMPARE pfnCompare, int nCol, int nKeyCol, BOOL bAscending, LPARAM data,
                   int low, int high);
