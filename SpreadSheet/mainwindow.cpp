...
void MainWindow::createLanguageMenu()
{
	...
	QDir qmDir = directoryOf("languages");
	QStringList fileNames =
		qmDir.entryList(QStringList("spreadsheet_*.qm"));
...
void MainWindow::switchLanguage(QAction *action)
{
	...
	QString qmPath = directoryOf("languages").absolutePath();
	appTranslator->load("spreadsheet_" + locale, qmPath);
