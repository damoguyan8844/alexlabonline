/*
 * $Id: NatThread.cpp 18513 2010-03-24 09:41:45Z huby $
 * 
...
/*
		...
		if(cid==0 || !::IsLowID(cid))
		{
			if(!cid)
			{
				...
				else if(!Kademlia::CKademlia::IsConnected() && CGlobalVariable::clientlist && CGlobalVariable::clientlist->GetClientCount()==0 
					&& CGlobalVariable::sharedfiles && CGlobalVariable::sharedfiles->GetCount()==0 )
				{
					Sleep(1000);
					continue;
				}
