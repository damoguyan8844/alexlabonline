...
<head>
<title>Alex's Space , Building ...... </title>
...
%>
<frameset rows="155,*,30" style="border:none 0px" border="0">
	<frame src="top.flash.asp" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" />
	<frameset cols="200,6,*" style="border:none 0px;" border="0">
